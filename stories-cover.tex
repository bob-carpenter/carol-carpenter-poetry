...
\setlength{\paperwidth}{13.944in}
\setlength{\paperheight}{9.861in}
\pdfpagewidth=\paperwidth
\pdfpageheight=\paperheight

\setlength{\textwidth}{13.944in}
...
\definecolor{medvintageorange}{rgb}{0.825, 0.525, 0.0} % A darker shade of vintage orange

\pagestyle{empty}\pagecolor{medvintageorange}\color{white}
\begin{document}
\noindent%
...
\begin{minipage}[t][9.861in][t]{0.694in}
   ...
   \hspace*{0.125in}%
    \rotatebox{270}{%
       {\fontsize{40}{40}\sffamily\bfseries stories
         $\mid$ carol carpenter}
     }
\end{minipage}%
%   
